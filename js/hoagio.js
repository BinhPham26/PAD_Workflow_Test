function DMSStringToArcSeconds(dmsRaw) {
    ...
    document.getElementById("input3").addEventListener("input", () => {
      ...
      document.getElementById("input5").value = customDecimal !== null ? customDecimal.toFixed(6).replace(/\.?0+$/, "") : "";
      document.getElementById("input9").value = customDecimal !== null ? customDecimal.toFixed(6).replace(/\.?0+$/, "") : "";
    ...
    document.getElementById("input4").addEventListener("input", () => {
      ...
      document.getElementById("input5").value = decimal !== null ? decimal.toFixed(6).replace(/\.?0+$/, "") : "Lỗi";
      document.getElementById("input9").value = decimal !== null ? decimal.toFixed(6).replace(/\.?0+$/, "") : "Lỗi";
    ...
    document.getElementById("input6").addEventListener("input", () => {
      ...
      document.getElementById("input8").value = decimal !== null ? decimal.toFixed(6).replace(/\.?0+$/, "") : "";
      document.getElementById("input10").value = decimal !== null ? decimal.toFixed(6).replace(/\.?0+$/, "") : "";
    });
